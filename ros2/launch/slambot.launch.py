...
def generate_launch_description():
    ...
    # ])
    return LaunchDescription([
        Node(package='rosbridge_server',node_executable='rosbridge_websocket',output='screen'),
        Node(package='rplidar_ros',node_executable='rplidarNode',output='screen'),
        Node(package='slambot_ctl',node_executable='controller',output='screen')
